...
const SLUG = 'why-chopras-indian-restaurant-is-a-top-choice-for-authentic-indian-food-in-den-haag'
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: '/images/blog/30ag.png', width: 1200, height: 630, alt: title }],
      type: 'article',
    },
    twitter: {
      ...
      title,
      description,
      images: ['/images/blog/30ag.png'],
    },
  }
}

export default function StandaloneWhyChoprasTopChoiceBlogPage({ params }: Props) {
