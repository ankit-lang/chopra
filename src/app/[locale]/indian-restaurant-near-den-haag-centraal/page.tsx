        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10">
            {isNl ? (
              <>
                <div>
                  <h3 className="font-vibes text-3xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mb-4 leading-[1.3]">Met de Tram</h3>
                  <p className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed">
                ...
                <div>
                  <h3 className="font-vibes text-3xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mb-4 leading-[1.3]">Met de Bus</h3>
                  <p className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed">
                ...
                <div>
                  <h3 className="font-vibes text-3xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mb-4 leading-[1.3]">Met de Auto</h3>
                  <p className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed">
                ...
                <div>
                  <h3 className="font-vibes text-3xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mb-4 leading-[1.3]">Bezorging aan Huis</h3>
                  <p className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed">
                    Wilt u thuis genieten van <Link href={`${base}/indian-food-delivery-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">Indiaas eten met bezorging</Link> in Den Haag? Chopras Indian Restaurant bezorgt via Thuisbezorgd en Uber Eats door heel Den Haag. Bellen voor afhalen bij Leyweg 986 kan ook. Beschikbaar van dinsdag tot en met zondag vanaf 16:30.
                  </p>
                </div>
              </>
            ) : (
              <>
                <div>
                  <h3 className="font-vibes text-3xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mb-4 leading-[1.3]">By Tram</h3>
                  <p className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed">
                ...
                <div>
                  <h3 className="font-vibes text-3xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mb-4 leading-[1.3]">By Bus</h3>
                  <p className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed">
                ...
                <div>
                  <h3 className="font-vibes text-3xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mb-4 leading-[1.3]">By Car</h3>
                  <p className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed">
                ...
                <div>
                  <h3 className="font-vibes text-3xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mb-4 leading-[1.3]">Delivery to Your Door</h3>
                  <p className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed">
                    Prefer to stay home? <Link href={`${base}/indian-food-delivery-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">Indian food delivery from Chopras</Link> is available through Thuisbezorgd and Uber Eats across Den Haag. You can also call to arrange collection at Leyweg 986. Available Tuesday to Sunday from 16:30 to 22:30.
                  </p>
                </div>
              </>
            )}
      ...
      <section className="py-20 px-6 md:px-16 bg-[#F7F8FC]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Link href={`${base}/indo-chinese-restaurant-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-white hover:shadow-lg transition-all">
              <p className="text-white text-sm font-semibold uppercase tracking-widest mb-2">Indo Chinese</p>
