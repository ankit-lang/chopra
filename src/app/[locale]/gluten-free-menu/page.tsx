                  ...
                  <section className="bg-amber-50 border-y border-amber-200 py-4 px-6">
                        <div className="max-w-4xl mx-auto flex items-center justify-center gap-3 text-amber-950 text-center">
                              ...
                              <p className="font-body text-sm md:text-base font-semibold leading-relaxed">
                                    {isNl
                                          ? 'Belangrijk: Vermeld bij uw bestelling uitdrukkelijk dat u de gerechten glutenvrij wilt hebben. Gerechten worden niet standaard glutenvrij bereid.'
                                          : 'Important: While ordering, please mention that you need the dishes gluten-free. Dishes are not prepared gluten-free by default.'}
                              </p>
                        </div>
                  </section>
