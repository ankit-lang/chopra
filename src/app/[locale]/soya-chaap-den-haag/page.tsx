          ...
          <div className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed space-y-5">
            {isNl ? (
              <>
                ...
                <p>Bij Chopras worden de specerijen elke ochtend vers gemalen uit hele kruidenzaden die direct uit India worden betrokken. Geen zakje, geen poedermix uit een leveranciersbak. <Link href={`${base}/tandoori-den-haag`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">De tandoor</Link> bereikt 400 graden Celsius. Die combinatie - verse achari kruiden en extreme hitte - geeft de soya chaap een rokerig korstje dat een gewone oven nooit kan repliceren. 4,9 sterren van 1300+ Google-beoordelingen. Dat niveau geldt voor elk gerecht, inclusief dit.</p>
              </>
            ) : (
              <>
