          ...
          <div className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed space-y-5">
            {isNl ? (
              ...
              <>
                ...
                <p>With <strong>4.9 stars from 800+ verified reviews</strong>, Chopras Indian Restaurant is one of the strongest-rated Indian restaurants in Den Haag. The pani puri we serve follows the same recipe and the same commitment to freshness as everything else from our kitchen. The spices are ground fresh every morning. The puri is fried daily. The pani is made the same day. This is <Link href={`${base}/blog/indian-street-food-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">authentic Indian street food in Den Haag</Link>, not an approximation of it.</p>
              </>
            )}
          </div>
        </div>
      ...
      <section className="bg-[#F7F8FC] py-20 px-6 md:px-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed space-y-5">
            {isNl ? (
              <>
                <h3 className="font-vibes text-3xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mt-6 mb-4">De Puri</h3>
                <p>De puri begint met maida, fijn tarwebloem, vermengd met semolina, water en zout tot een strak, elastisch deeg. Het deeg wordt uitgerold en uitgestoken in kleine ronde vormpjes. Elk rondje gaat in hete olie op de juiste temperatuur. Te laag en ze worden vet. Te hoog en ze verbranden voor ze opbollen. De puri moet volledig hol opblazen en goudgeel worden, niet bruin. Chopras bakt de puri elke dag vers, twee tot drie keer per service, zodat u nooit een oudbakken puri eet van ons <Link href={`${base}/menu`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">volledige Indiase menu in Den Haag</Link>.</p>
                <h3 className="font-vibes text-3xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mt-6 mb-4">De Vulling</h3>
                <p>Verse aardappelen worden die ochtend gekookt, niet te zacht. Ze worden met de hand in kleine stukjes gebroken en gemengd met gekookte kikkererwten, fijngehakte groene chili, chaat masala, garam masala, kurkuma en zwart zout. Niet gepureerd. Niet glad. De vulling moet textuur hebben. U voelt elk onderdeel afzonderlijk: de aardappel, de kikkererwt, de specerij. Onze kruiden worden elke ochtend vers gemalen uit hele specerijen die rechtstreeks uit India worden betrokken, de kern van <Link href={`${base}/blog/vegetarian-indian-food-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">authentiek vegetarisch Indiaas eten Den Haag</Link>.</p>
                <h3 className="font-vibes text-3xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mt-6 mb-4">De Pani</h3>
                ...
                <h3 className="font-vibes text-3xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mt-6 mb-4">De Samenstelling</h3>
                <p>Wanneer u pani puri bestelt, doet onze kok het volgende. Hij pakt een puri. Met zijn duim maakt hij een klein gat aan de bovenkant, niet te groot, niet te klein. Hij lepelt de aardappelvulling erin. Hij voegt een scheutje zoete tamarindchutney toe. Dan dompelt hij hem volledig onder in de pani. Nu heeft u uw pani puri. U eet hem onmiddellijk. Elke seconde die u wacht, verliest u knapperigheid. Het ideale moment is direct na de samenstelling. Dat is de kunst van dit gerecht. <Link href={`${base}/contact`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">Reserveer een tafel bij Chopras</Link> om het zelf te ervaren.</p>
              </>
            ) : (
              <>
                <h3 className="font-vibes text-3xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mt-6 mb-4">The Puri</h3>
                <p>The puri starts with maida, fine wheat flour, mixed with semolina, water and salt into a tight, elastic dough. The dough is rolled out and cut into small rounds. Each round goes into hot oil at the right temperature. Too low and they become greasy. Too high and they burn before they puff. The puri must inflate fully hollow and turn golden, not brown. Chopras fries puri fresh every day, two to three times per service, so you never eat a stale one from our <Link href={`${base}/menu`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">full Indian restaurant menu Den Haag</Link>.</p>
                <h3 className="font-vibes text-3xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mt-6 mb-4">The Filling</h3>
                <p>Fresh potatoes are boiled that morning, not too soft. They are broken by hand into small pieces and mixed with cooked chickpeas, finely chopped green chilli, chaat masala, garam masala, turmeric and black salt (kala namak). Not mashed. Not smooth. The filling must have texture. You feel each component separately: the potato, the chickpea, the spice. Our spices are ground fresh every morning from whole spices sourced directly from India, which is the foundation of <Link href={`${base}/blog/vegetarian-indian-food-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">authentic vegetarian Indian food Den Haag</Link>.</p>
                <h3 className="font-vibes text-3xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mt-6 mb-4">The Pani</h3>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="font-body text-white/80 text-lg leading-relaxed">
            {isNl ? (
              ...
              <p>Authentic pani puri in Den Haag is available at Chopras Indian Restaurant, located at Leyweg 986, 2545 GW Den Haag. The kitchen fries fresh puri daily, fills each shell with spiced potato and tamarind water, and serves every order immediately. With 4.9 stars from 800+ verified reviews, Chopras Indian Restaurant is one of the strongest-rated Indian restaurants in Den Haag. Open Tuesday to Sunday from 16:30. Browse our full <Link href={`${base}/chaat-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">chaat menu Den Haag</Link> or <Link href={`${base}/contact`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">reserve a table at Chopras Indian Restaurant</Link>.</p>
            )}
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-20 px-6 md:px-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed space-y-5 mb-8">
            {isNl ? (
              <>
                <p>Chopras Indian Restaurant is open dinsdag tot zondag vanaf 16:30 op Leyweg 986, 2545 GW Den Haag. Pani puri wordt geserveerd als onderdeel van ons <Link href={`${base}/menu`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">volledige Indiase menu Den Haag</Link> naast andere chaat-opties. Lees ook ons artikel over <Link href={`${base}/blog/indian-street-food-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">Indiaas straatvoedsel in Den Haag</Link> voor de volledige selectie.</p>
                <p>Wilt u pani puri voor een feestje of evenement? Chopras Indian Restaurant verzorgt ook <Link href={`${base}/catering`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">Indiaas catering Den Haag</Link> voor verjaardagen, bruiloften en bedrijfsbijeenkomsten. Pani puri werkt als een interactief en indrukwekkend startgerecht voor elke groep.</p>
              </>
            ) : (
              <>
                <p>Chopras Indian Restaurant is open Tuesday to Sunday from 16:30 at Leyweg 986, 2545 GW Den Haag. Pani puri is served as part of our <Link href={`${base}/menu`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">full Indian restaurant menu Den Haag</Link> alongside other chaat options. Read our guide to <Link href={`${base}/blog/indian-street-food-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">Indian street food in Den Haag</Link> for the complete selection.</p>
                <p>Want pani puri for a party or event? Chopras Indian Restaurant also provides <Link href={`${base}/catering`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">Indian catering Den Haag</Link> for birthdays, weddings and corporate gatherings. Pani puri works as an interactive and impressive starter dish for any group size.</p>
              </>
            )}
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <Link href={`${base}/soya-chaap-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-white hover:shadow-lg transition-all">
              <p className="text-white text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Veganistisch' : 'Vegan'}</p>
