...
export default function DiwaliDinnerPage({ params }: Props) {
  ...
  return (
    <>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed space-y-8">
            {isNl ? (
              <>
                <div>
                  <h3 className="font-heading text-3xl text-[#06068a] mb-4">Reserveer een Tafel</h3>
                ...
                <div>
                  <h3 className="font-heading text-3xl text-[#06068a] mb-4">Diwali-Catering aan Huis of op Locatie</h3>
                ...
                <div>
                  <h3 className="font-heading text-3xl text-[#06068a] mb-4">Privezaal voor 25 tot 80 Gasten</h3>
                  <p>Voor grotere familievieringen kunt u onze <Link href={`${base}/feestzaal-den-haag`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">privezaal in Den Haag</Link> huren op Leyweg 986. De zaal biedt ruimte aan 25 tot 80 gasten en het eten wordt geserveerd vanuit dezelfde keuken als het restaurant. Geen externe cateraar, geen concessies aan kwaliteit.</p>
                </div>
              </>
            ) : (
              <>
                <div>
                  <h3 className="font-heading text-3xl text-[#06068a] mb-4">Reserve a Table</h3>
                ...
                <div>
                  <h3 className="font-heading text-3xl text-[#06068a] mb-4">Diwali Catering for Home or Venue</h3>
      ...
      <section className="bg-white py-16 px-6 md:px-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link
              href={`${base}/catering`}
              className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-white btn-gradient px-6 py-3 text-white text-sm font-semibold uppercase tracking-wide transition-all duration-200 ease-out hover:bg-transparent hover:text-white active:scale-[0.98] min-h-[48px]"
            >
      ...
      <section className="bg-white py-16 px-6 md:px-16">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-heading text-4xl md:text-5xl text-[#06068a] mb-10 leading-[1.4] text-center">
            {isNl ? 'Andere Cateringmogelijkheden' : 'Other Catering Options'}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <Link href={`${base}/indian-wedding-catering-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
            ...
            <Link href={`${base}/corporate-events-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
            ...
            <Link href={`${base}/feestzaal-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              <p className="text-[#06068a] text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Feestzaal' : 'Event Space'}</p>
              <p className="text-[#06068a] font-semibold">{isNl ? 'Feestzaal huren voor Diwali in Den Haag' : 'Event space for Diwali in Den Haag'}</p>
            </Link>
            <Link href={`${base}/indian-birthday-catering-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              <p className="text-[#06068a] text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Verjaardag' : 'Birthday'}</p>
              <p className="text-[#06068a] font-semibold">{isNl ? 'Verjaardagsfeesten en jubileums' : 'Birthday parties and celebrations'}</p>
            </Link>
          </div>
          <div className="mt-8 text-center space-y-4">
            ...
            <p className="font-body text-[#1A1A1A] text-lg">
              ...
              <Link href={`${base}/menu`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">{tr.common.viewMenu.toLowerCase()}</Link>
              {' '}{isNl ? 'of' : 'or'}{' '}
              <Link href={`${base}/contact`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">{isNl ? 'neem contact op' : 'contact us'}</Link>
