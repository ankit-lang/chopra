            ...
            {isNl ? (
              <>
                ...
                <p>
                  ...
                  <Link href={`${base}/chaat-den-haag`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">
                    chaat
                  </Link>{' '}
          ...
          <div className="space-y-5 font-body text-[#1A1A1A]/70 text-lg leading-relaxed">
            {isNl ? (
              <>
                ...
                <p>
                  Chopras heeft een 4,9-sterrenbeoordeling op Google van meer dan 1100 geverifieerde
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {weddingOccasions.map((occasion) => (
              <div key={occasion.title} className="bg-white rounded-xl p-6 border-l-4 border-white">
                <h3 className="font-heading text-3xl text-[#06068a] mb-4">{occasion.title}</h3>
          ...
          <div className="font-body text-white/90 text-lg leading-relaxed">
            {isNl ? (
              <p className='!text-white/80'>
                ...
                vanuit de keuken op{' '}
                <Link href={`${base}/contact`} className="text-white hover:text-white font-semibold">
                ...
                heeft een 4,9-sterrenbeoordeling van meer dan 1100 Google-beoordelingen en is geopend
      ...
      <section className="bg-white py-20 px-6 md:px-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href={`${base}/catering#catering-form`}
              className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-white btn-gradient px-6 py-3 text-white text-sm font-medium uppercase tracking-wide transition-all duration-200 ease-out  active:scale-[0.98] min-h-[48px] cursor-pointer"
            >
              {isNl ? 'Bruiloftsofferte Aanvragen' : 'Get a Wedding Quote'}
            </Link>
            <a
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            <Link href={`${base}/indian-birthday-catering-den-haag`} className="block p-6 bg-[#F7F8FC] rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              ...
              <p className="text-[#06068a] font-semibold">{isNl ? 'Indiase verjaardagscatering Den Haag' : 'Indian birthday catering Den Haag'}</p>
            </Link>
            <Link href={`${base}/corporate-events-den-haag`} className="block p-6 bg-[#F7F8FC] rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              <p className="text-[#06068a] text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Bedrijfsgebeurtenis' : 'Corporate Event'}</p>
              <p className="text-[#06068a] font-semibold">{isNl ? 'Indiase catering voor bedrijven' : 'Indian catering for corporate events'}</p>
            </Link>
            <Link href={`${base}/diwali-dinner-den-haag`} className="block p-6 bg-[#F7F8FC] rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              ...
              <p className="text-[#06068a] font-semibold">{isNl ? 'Diwali-diner Den Haag' : 'Diwali dinner Den Haag'}</p>
            </Link>
            <Link href={`${base}/feestzaal-den-haag`} className="block p-6 bg-[#F7F8FC] rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              ...
              <p className="text-[#06068a] font-semibold">{isNl ? 'Feestzaal huren voor bruiloft Den Haag' : 'Event space rental for weddings Den Haag'}</p>
            </Link>
          </div>
