        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed space-y-5">
            {isNl ? (
              ...
              <>
                <p>The shortest answer is consistency. When you book corporate catering in Den Haag, the concern is not whether the food will taste good on the day. The concern is whether it will taste as good as the quote promised. Chopras Indian Restaurant holds 4.9 stars from 1100+ verified Google reviews. That rating comes from regular guests and from corporate clients booking groups of 30, 50 and 80. The kitchen does not maintain a separate standard for events.</p>
