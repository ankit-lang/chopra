      ...
      <section className="bg-[#1B2B5E] py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-white/90 text-lg leading-relaxed">
            {isNl ? (
              <p>Arun Chopra is de oprichter van Chopras Indian Restaurant, gevestigd op Leyweg 986, 2545 GW Den Haag. Het restaurant werd in 2023 opgericht met de missie om authentieke Noord-Indiaase keuken exact zoals het in India gegeten wordt naar Den Haag te brengen. Chopras staat beoordeeld met 4,9 sterren op basis van 1300+ Google-recensies. Alle gerechten zijn <Link href={`${base}/halal-food-den-haag`} className="text-white hover:underline font-semibold">volledig halal gecertificeerd</Link>. <Link href={`${base}/contact`} className="text-white hover:underline font-semibold">Het restaurant is open dinsdag tot zondag van 16:30 tot 22:30</Link>.</p>
            ) : (
              <p>Arun Chopra is the founder of Chopras Indian Restaurant, located at Leyweg 986, 2545 GW Den Haag. The restaurant was established in 2023 with the mission to bring authentic North Indian food to Den Haag, prepared exactly as it is eaten in India. Chopras is rated 4.9 stars across 1300+ Google reviews. All dishes are <Link href={`${base}/halal-food-den-haag`} className="text-white hover:underline font-semibold">fully halal certified</Link>. <Link href={`${base}/contact`} className="text-white hover:underline font-semibold">The restaurant is open Tuesday to Sunday from 16:30 to 22:30</Link>.</p>
            )}
          </div>
        </div>
      </section>
