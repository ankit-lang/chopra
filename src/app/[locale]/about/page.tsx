    ...
    <>
      ...
      <section className="bg-[#1B2B5E] py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-white/90 text-lg leading-relaxed">
            {isNl ? (
              <p>Arun Chopra is de oprichter van Chopras Indian Restaurant, gevestigd op Leyweg 986, 2545 GW Den Haag. Het restaurant werd in 2023 opgericht met de missie om authentieke Noord-Indiaase keuken exact zoals het in India gegeten wordt naar Den Haag te brengen. Chopras staat beoordeeld met 4,9 sterren op basis van 800+ Google-recensies. Alle gerechten zijn <Link href={`${base}/halal-food-den-haag`} className="text-white hover:underline font-semibold">volledig halal gecertificeerd</Link>. <Link href={`${base}/contact`} className="text-white hover:underline font-semibold">Het restaurant is open dinsdag tot zondag van 16:30 tot 22:30</Link>.</p>
            ) : (
              <p>Arun Chopra is the founder of Chopras Indian Restaurant, located at Leyweg 986, 2545 GW Den Haag. The restaurant was established in 2023 with the mission to bring authentic North Indian food to Den Haag, prepared exactly as it is eaten in India. Chopras is rated 4.9 stars across 800+ Google reviews. All dishes are <Link href={`${base}/halal-food-den-haag`} className="text-white hover:underline font-semibold">fully halal certified</Link>. <Link href={`${base}/contact`} className="text-white hover:underline font-semibold">The restaurant is open Tuesday to Sunday from 16:30 to 22:30</Link>.</p>
            )}
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-lg max-w-none text-[#1A1A1A] space-y-6">
            {isNl ? (
              <>
                ...
                <p>Dit betekent dat je bij Chopras <Link href={`${base}/butter-chicken-den-haag`} className="text-white hover:underline font-semibold">butter chicken eet zoals het in Delhi gegeten wordt</Link>, niet zoals het in Europa is aangepast. Het betekent dat <Link href={`${base}/dal-makhani-den-haag`} className="text-white hover:underline font-semibold">dal makhani langzaam wordt gekookt</Link> met verse ingredienten die die ochtend zijn gemaald. Het betekent dat de <Link href={`${base}/tandoori-den-haag`} className="text-white hover:underline font-semibold">tandoori-technieken exact volgen</Link> wat in India al eeuwenlang wordt gedaan.</p>
              ...
              <>
                ...
                <p>This means when you eat at Chopras, you eat <Link href={`${base}/butter-chicken-den-haag`} className="text-white hover:underline font-semibold">butter chicken as it is eaten in Delhi</Link>, not as it has been adapted for Europe. It means <Link href={`${base}/dal-makhani-den-haag`} className="text-white hover:underline font-semibold">dal makhani is slow-cooked</Link> with fresh ingredients ground that morning. It means <Link href={`${base}/tandoori-den-haag`} className="text-white hover:underline font-semibold">tandoori techniques follow exactly</Link> what has been done in India for centuries.</p>
      ...
      <section className="bg-[#F7F8FC] py-20 px-6 md:px-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-[#1A1A1A] space-y-6">
            {isNl ? (
              <>
                <p>Chopras werd geopend in 2023 op Leyweg 986 in Den Haag. Het restaurant heeft plaats voor 25 tot 80 gasten en beschikt over een aparte <Link href={`${base}/feestzaal-den-haag`} className="text-white hover:underline font-semibold">private feestzaal voor bruiloften, verjaardagen en bedrijfsfeesten</Link>. Open dinsdag tot en met zondag van 16:30 tot 22:30. Gesloten op maandag.</p>
                <p>Het menu biedt meer dan 143 gerechten - <Link href={`${base}/vegan-menu`} className="text-white hover:underline font-semibold">vegetarische en veganistische opties</Link>, biryani, tandoori, North Indian curries en <Link href={`${base}/indo-chinese-restaurant-den-haag`} className="text-white hover:underline font-semibold">Indo-Chinese fusion food</Link>. Alle gerechten kunnen <Link href={`${base}/indian-food-delivery-den-haag`} className="text-white hover:underline font-semibold">bezorgd worden of afhalen</Link> voor degenen die thuis willen genieten.</p>
              ...
              <>
                <p>Chopras opened in 2023 at Leyweg 986 in Den Haag. The restaurant seats 25 to 80 guests and features a dedicated <Link href={`${base}/feestzaal-den-haag`} className="text-white hover:underline font-semibold">private event hall for weddings, birthdays and corporate celebrations</Link>. Open Tuesday to Sunday from 16:30 to 22:30. Closed Mondays.</p>
                <p>The menu offers 143+ dishes - <Link href={`${base}/vegan-menu`} className="text-white hover:underline font-semibold">vegetarian and vegan options</Link>, biryani, tandoori, North Indian curries and <Link href={`${base}/indo-chinese-restaurant-den-haag`} className="text-white hover:underline font-semibold">Indo-Chinese fusion food</Link>. All dishes can be <Link href={`${base}/indian-food-delivery-den-haag`} className="text-white hover:underline font-semibold">delivered or collected</Link> for those who want to enjoy at home.</p>
      ...
      <section className="bg-white py-20 px-6 md:px-16">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-vibes text-4xl md:text-5xl text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] mb-8 leading-[1.4]">
