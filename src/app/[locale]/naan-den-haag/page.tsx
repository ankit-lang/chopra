          ...
          <div className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed space-y-5">
            {isNl ? (
              <>
                ...
                <p><strong>Knoflooknaan.</strong> De meest bestelde. Vers deeg, hete tandoor, dan direct een kwast gesmolten boter en fijngehakte knoflook zodra het eruit komt. De knoflook gaart licht tegen het warme oppervlak. Het zit niet rauw bovenop. Bestellen naast <Link href={`${base}/butter-chicken-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">butter chicken Den Haag</Link> is bijna een verplichting.</p>
                <p><strong>Boternaan.</strong> De klassieke. Gewone tandoori naan met een royale kwast geklaarde boter. Eet het met <Link href={`${base}/dal-makhani-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">dal makhani Den Haag</Link> en er blijft niets op het bord over.</p>
                ...
                <p><strong>Keema naan.</strong> Gekruid gehakt lamsvlees gevouwen in het deeg. Halal gecertificeerd. Deze is op zichzelf al een vol bord, maar de meeste gasten bestellen hem toch naast een curry van het <Link href={`${base}/menu`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">volledige Chopras menu</Link>.</p>
                <p><strong>Gewone naan.</strong> Het origineel. Tandoor hitte, deeg, verder niets. Als de basis goed is, is er niets anders nodig. Bij 400 graden verdient de gewone naan zijn plek op elk bord. Combineer het met <Link href={`${base}/mutton-rogan-josh-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">mutton rogan josh Den Haag</Link> voor een samenspel dat voor zichzelf spreekt.</p>
              </>
            ) : (
              <>
                ...
                <p><strong>Garlic naan.</strong> The most ordered. Fresh dough, hot tandoor, then immediately a brush of melted butter and finely chopped garlic the moment it comes out. The garlic cooks slightly against the warm surface. It does not sit raw on top. Ordering this alongside <Link href={`${base}/butter-chicken-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">butter chicken Den Haag</Link> is practically obligatory.</p>
                <p><strong>Butter naan.</strong> The classic. Plain tandoor naan with a generous brush of clarified butter. Eat it with <Link href={`${base}/dal-makhani-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">dal makhani Den Haag</Link> and nothing is left on the plate.</p>
                ...
                <p><strong>Keema naan.</strong> Spiced minced lamb folded into the dough. Halal certified. This one is a full plate on its own, though most guests still order it alongside a curry from the <Link href={`${base}/menu`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">full Chopras menu</Link>.</p>
                <p><strong>Plain naan.</strong> The original. Tandoor heat, dough, nothing else. If the base is right, nothing more is needed. At 400 degrees, plain naan earns its place. Serve it with <Link href={`${base}/mutton-rogan-josh-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">mutton rogan josh Den Haag</Link> for a combination that speaks for itself.</p>
              </>
            )}
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <Link href={`${base}/tandoori-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-white hover:shadow-lg transition-all">
              <p className="text-white text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Tandoor' : 'Tandoor'}</p>
            ...
            <Link href={`${base}/butter-chicken-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-white hover:shadow-lg transition-all">
              <p className="text-white text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Curry' : 'Curry'}</p>
            ...
            <Link href={`${base}/biryani-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-white hover:shadow-lg transition-all">
              <p className="text-white text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Rijst' : 'Rice'}</p>
