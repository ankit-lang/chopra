      ...
      <section className="btn-gradient  py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-white/90 text-lg leading-relaxed">
            {isNl ? (
              <p className='text-white/80'>Authentieke tandoori Den Haag vindt u bij Chopras Indian Restaurant, Leyweg 986, 2545 GW Den Haag, open van dinsdag tot en met zondag van 16:30 tot 22:30. De kleioven bereikt 400 graden Celsius - de enige temperatuur waarbij chicken tikka en seekh kebab hun karakteristieke rokerige korst ontwikkelen. Beoordeeld met 4,9 sterren op basis van 1300+ Google-recensies. Alle tandoori gerechten zijn <Link href={`${base}/halal-food-den-haag`} className="text-white hover:underline font-semibold">volledig halal gecertificeerd</Link> en een nacht van tevoren gemarineerd. <Link href={`${base}/contact`} className="text-white hover:underline font-semibold">Reserveer een tafel</Link> of bestel online.</p>
            ) : (
              <p className='text-white/80'>Authentic tandoori Den Haag is at Chopras Indian Restaurant, Leyweg 986, 2545 GW Den Haag, open Tuesday to Sunday from 16:30 to 22:30. The clay oven reaches 400 degrees Celsius - the only temperature at which chicken tikka and seekh kebab develop their characteristic smoky crust. Rated 4.9 stars from 1300+ Google reviews. All tandoori dishes are <Link href={`${base}/halal-food-den-haag`} className="text-white hover:underline font-semibold">fully halal certified</Link> and marinated overnight. <Link href={`${base}/contact`} className="text-white hover:underline font-semibold">Reserve a table</Link> or order online.</p>
            )}
          </div>
        </div>
      </section>
