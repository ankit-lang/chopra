    ...
    <>
      ...
      <section className="btn-gradient py-20 text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="font-body text-white/85 text-lg md:text-xl mt-6 mb-8 max-w-2xl mx-auto">
          ...
          <div className="space-y-10">
            <div>
              ...
              <p className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed">
                ...
                <Link href={`${base}/corporate-events-den-haag`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">corporate events in Den Haag</Link>{' '}
            ...
            <div>
              ...
              <p className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed">
                ...
                <Link href={`${base}/biryani-den-haag`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">authentieke biryani</Link>{' '}
                of{' '}
                <Link href={`${base}/tandoori-den-haag`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">tandoori uit onze kleioven</Link>{' '}
      ...
      <section className="btn-gradient py-20 px-6 md:px-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-10 text-center">
            <Link
              href={`${base}/contact`}
              className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-white bg-white/10 px-8 py-3 text-white text-sm font-medium uppercase tracking-wide transition-all duration-200 ease-out active:scale-[0.98] min-h-[48px] backdrop-blur-[10px]"
            >
      ...
      <section className="bg-[#F7F8FC] py-20 px-6 md:px-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed mb-8">
            ...
            <Link href={`${base}/contact`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">onze contactpagina</Link>{' '}
            of mail direct naar <EmailLink />. Wij reageren binnen een werkdag. U kunt ook het{' '}
            <Link href={`${base}/indian-buffet-den-haag`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">Indiaas buffet arrangement</Link>{' '}
