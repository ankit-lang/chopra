          ...
          <div className="space-y-5 font-body text-[#1A1A1A]/70 text-lg leading-relaxed">
            {isNl ? (
              ...
              <>
                ...
                <p>The menu spans 143 dishes across thirteen categories - from <Link href={`${base}/biryani-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">saffron biryani</Link> and <Link href={`${base}/dal-makhani-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">slow-cooked dal makhani</Link> to authentic street food that is hard to find elsewhere in Den Haag. All from the same kitchen. Same spices, every evening.</p>
              </>
            )}
          </div>
        </div>
