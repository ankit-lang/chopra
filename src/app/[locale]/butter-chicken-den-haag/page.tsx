      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-[#1A1A1A] space-y-5">
            {isNl ? (
              <>
                <p>De kip wordt <Link href={`${base}/tandoori-den-haag`} className="text-white hover:underline">de avond van tevoren gemarineerd in onze tandoor-keuken</Link>. Niet een uur voor de service - de avond ervoor. De marinade is op basis van yoghurt met verse gember, knoflook en een mengsel van kruiden die die ochtend in huis zijn gemalen. De yoghurt maakt het vlees malser en draagt de kruiden diep in het vlees, zodat de kip tegen de tijd dat het de tandoor bereikt, al van binnenuit smaak heeft opgenomen.</p>
                ...
                <p>De saus begint met verse tomaten die langzaam worden gekookt gedurende ongeveer 45 minuten totdat het water is verdampt en de natuurlijke suikers zijn geconcentreerd. Volle room wordt vervolgens op de juiste temperatuur toegevoegd. De boter - makhan, de makhani in murgh makhani - wordt aan het einde geroerd, van het directe vuur af, zodat het emulsigeert in de saus in plaats van te breken. Chopras serveert dit gerecht elke avond als onderdeel van het <Link href={`${base}/menu`} className="text-white hover:underline">volledige Noord-Indiase menu</Link>.</p>
                <p>De kruiden worden in huis gemalen van hele kruiden rechtstreeks uit India: groene kardemom, kruidnagel, kaneel, gedroogde rode peper, korianderzaad en komijn. Alle kip is afkomstig van <Link href={`${base}/halal-food-den-haag`} className="text-white hover:underline">halal-gecertificeerde leveranciers</Link>. Elk gerecht, elke avond. Butter chicken staat op de kaart voor €18,50.</p>
              </>
            ) : (
              <>
                <p>The chicken is <Link href={`${base}/tandoori-den-haag`} className="text-white hover:underline">marinated overnight in our tandoor kitchen</Link>. Not for an hour before service - overnight. The marinade is yogurt-based with fresh ginger, garlic, and a blend of spices ground in-house that morning. The yogurt tenderises the meat and carries the spices deep into the flesh, so by the time the chicken reaches the tandoor, it has already been absorbing flavour from within.</p>
                ...
                <p>The sauce starts with fresh tomatoes cooked down slowly for around 45 minutes until the water has evaporated and the natural sugars have concentrated. Full-fat cream is then added at the correct temperature. The butter - makhan, the makhani in murgh makhani - is stirred in at the end, off the direct heat, so it emulsifies into the sauce rather than breaking. Chopras serves this dish nightly as part of the <Link href={`${base}/menu`} className="text-white hover:underline">full North Indian menu</Link>.</p>
                <p>The spices are ground in-house from whole spices sourced directly from India: green cardamom, cloves, cinnamon, dried red chilli, coriander seed, and cumin. All chicken is sourced from <Link href={`${base}/halal-food-den-haag`} className="text-white hover:underline">halal-certified suppliers</Link>. Every dish, every evening. Butter chicken is priced at €18.50.</p>
              </>
            )}
          </div>
        </div>
