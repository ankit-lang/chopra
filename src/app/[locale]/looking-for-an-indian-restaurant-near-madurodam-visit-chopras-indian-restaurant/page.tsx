...
const SLUG = 'looking-for-an-indian-restaurant-near-madurodam-visit-chopras-indian-restaurant'
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: '/images/blog/2sep.png', width: 1200, height: 630, alt: title }],
      type: 'article',
    },
    twitter: {
      ...
      title,
      description,
      images: ['/images/blog/2sep.png'],
    },
  }
}

export default function StandaloneBlogPage({ params }: Props) {
