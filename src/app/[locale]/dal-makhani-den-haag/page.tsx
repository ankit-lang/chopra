          ...
          <div className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed space-y-5">
            {isNl ? (
              <>
                ...
                <p>Dit is <Link href={`${base}/blog/vegetarian-indian-food-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">vegetarisch Indiaas comfort food</Link> zoals het bedoeld is. Niet als vervanging voor vlees. Als het echte ding.</p>
              </>
            ) : (
              <>
                ...
                <p>This is <Link href={`${base}/blog/vegetarian-indian-food-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">vegetarian Indian comfort food</Link> done as it was intended. Not as a substitute for meat. As the real thing.</p>
              </>
            )}
          </div>
        </div>
          ...
          <div className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed space-y-5">
            {isNl ? (
              <>
                ...
                <p>Met een Google-beoordeling van 4,9 sterren van 800+ beoordeelde gasten is dit het meest gewaardeerde <Link href={`${base}/beste-indiaas-restaurant-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">Indiaas restaurant in Den Haag</Link>. Dal makhani is een van de gerechten die gasten keer op keer terugbrengt.</p>
              </>
            ) : (
              <>
                ...
                <p>With a 4.9-star Google rating from 800+ verified reviews, Chopras is one of the strongest-rated <Link href={`${base}/beste-indiaas-restaurant-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">Indian restaurant in Den Haag</Link>. Dal makhani is one of the dishes that brings guests back.</p>
              </>
            )}
          </div>
        </div>
          ...
          <div className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed space-y-5">
            {isNl ? (
              ...
              <>
                ...
                <p>Dal makhani does not stand alone. Our <Link href={`${base}/vegan-menu`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">vegetarian and vegan menu</Link> also includes <Link href={`${base}/soya-chaap-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">soya chaap</Link> - plant-based mock meat grilled in the tandoor - along with paneer curries, chaat, and over twenty other vegetarian options across 143 dishes. Guests who do not eat meat find a complete menu at Chopras, not a side option.</p>
                <p>The entire kitchen is fully <Link href={`${base}/halal-food-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">halal certified</Link>. Chopras uses only halal-certified meat throughout, which means zero cross-contamination risk for guests who follow a strict halal standard.</p>
              </>
            )}
          </div>
        </div>
          ...
          <p className="font-body text-white/80 text-lg leading-relaxed">
            {isNl ? (
              <>
                ...
                <Link href={`${base}/contact`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">Leyweg 986, 2545 GW Den Haag</Link>.
                ...
                <Link href={`${base}/indian-takeaway-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">afhalen</Link>
              ...
              <>
                ...
                <Link href={`${base}/indian-takeaway-den-haag`} className="text-white hover:text-transparent bg-clip-text bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] font-semibold">takeaway</Link>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <Link href={`${base}/butter-chicken-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-white hover:shadow-lg transition-all">
              <p className="text-white text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Boter Kip' : 'Butter Chicken'}</p>
            ...
            <Link href={`${base}/soya-chaap-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-white hover:shadow-lg transition-all">
              <p className="text-white text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Soya Chaap' : 'Soya Chaap'}</p>
            ...
            <Link href={`${base}/naan-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-white hover:shadow-lg transition-all">
              <p className="text-white text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Naan' : 'Naan'}</p>
