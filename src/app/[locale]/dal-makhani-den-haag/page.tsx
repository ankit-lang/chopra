          ...
          <div className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed space-y-5">
            {isNl ? (
              <>
                ...
                <p>Dit is <Link href={`${base}/blog/vegetarian-indian-food-den-haag`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">vegetarisch Indiaas comfort food</Link> zoals het bedoeld is. Niet als vervanging voor vlees. Als het echte ding.</p>
              </>
            ) : (
              <>
                ...
                <p>This is <Link href={`${base}/blog/vegetarian-indian-food-den-haag`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">vegetarian Indian comfort food</Link> done as it was intended. Not as a substitute for meat. As the real thing.</p>
              </>
            )}
          </div>
        </div>
          ...
          <div className="font-body text-[#1A1A1A]/70 text-lg leading-relaxed space-y-5">
            {isNl ? (
              <>
                ...
                <p>Dal makhani staat niet alleen. Ons <Link href={`${base}/vegan-menu`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">vegetarisch en veganistisch menu</Link> omvat ook <Link href={`${base}/soya-chaap-den-haag`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">soya chaap</Link> - plantaardig vlees gegrild in de tandoor - evenals paneer curries, chaat en meer dan twintig andere vegetarische opties verspreid over 143 gerechten. Gasten die geen vlees eten vinden bij Chopras een volledig menu, geen bijgerecht.</p>
                <p>De gehele keuken is volledig <Link href={`${base}/halal-food-den-haag`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">halal gecertificeerd</Link>. Chopras verwerkt uitsluitend halal vlees, waardoor er geen risico op kruisbesmetting bestaat voor gasten die een strikte halal-standaard volgen.</p>
              </>
            ) : (
              <>
                ...
                <p>Dal makhani does not stand alone. Our <Link href={`${base}/vegan-menu`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">vegetarian and vegan menu</Link> also includes <Link href={`${base}/soya-chaap-den-haag`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">soya chaap</Link> - plant-based mock meat grilled in the tandoor - along with paneer curries, chaat, and over twenty other vegetarian options across 143 dishes. Guests who do not eat meat find a complete menu at Chopras, not a side option.</p>
                <p>The entire kitchen is fully <Link href={`${base}/halal-food-den-haag`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">halal certified</Link>. Chopras uses only halal-certified meat throughout, which means zero cross-contamination risk for guests who follow a strict halal standard.</p>
              </>
            )}
          </div>
        </div>
            ...
            {isNl ? (
              <>
                <p>
                  ...
                  <Link href={`${base}/naan-den-haag`} className="text-[#06068a] hover:text-[#0000B3] font-semibold">tandoori naan</Link>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <Link href={`${base}/butter-chicken-den-haag`} className="block p-6 bg-[#F7F8FC] rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              <p className="text-[#06068a] text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Boter Kip' : 'Butter Chicken'}</p>
              <p className="text-[#06068a] font-semibold">{isNl ? 'Rijke tomaten-room curry met halal kip' : 'Rich tomato cream curry with halal chicken'}</p>
            </Link>
            <Link href={`${base}/soya-chaap-den-haag`} className="block p-6 bg-[#F7F8FC] rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              <p className="text-[#06068a] text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Soya Chaap' : 'Soya Chaap'}</p>
              <p className="text-[#06068a] font-semibold">{isNl ? 'Plantaardig vlees gegrild in de tandoor' : 'Plant-based mock meat grilled in the tandoor'}</p>
            </Link>
            <Link href={`${base}/naan-den-haag`} className="block p-6 bg-[#F7F8FC] rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              <p className="text-[#06068a] text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Naan' : 'Naan'}</p>
              <p className="text-[#06068a] font-semibold">{isNl ? 'Vers gebakken tandoori naan uit de kleioven' : 'Fresh tandoori naan baked in the clay oven'}</p>
            </Link>
