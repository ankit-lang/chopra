...
const SLUG = 'best-indian-restaurant-in-den-haag-for-family-dining-parties-corporate-events'
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: '/images/blog/corporate.jpg', width: 1200, height: 630, alt: title }],
      type: 'article',
    },
    twitter: {
      ...
      title,
      description,
      images: ['/images/blog/corporate.jpg'],
    },
  }
}

export default function StandaloneFamilyDiningPartiesBlogPage({ params }: Props) {
