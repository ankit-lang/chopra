      ...
      <section className="bg-[#1B2B5E] py-20 text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/75 text-lg md:text-xl max-w-2xl mx-auto" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.7)' }}>
            {isNl
              ? 'Volledig halal-gecertificeerd. 143 Indiaas gerechten. 4,9 sterren op Google van 1300+ beoordelingen. Leyweg 986, Den Haag.'
              : 'Fully halal certified. 143 Indian dishes. 4.9 stars on Google from 1300+ reviews. Leyweg 986, Den Haag.'}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 mt-8 justify-center">
            <Link
              href={`${base}/contact`}
              className="inline-flex items-center justify-center rounded-full border-2 border-white bg-white/10 px-6 py-3 text-white font-medium uppercase tracking-wide transition-all duration-200 hover:bg-[rgba(199,163,72,0.3)] min-h-[48px]"
            >
              {tr.common.reserve}
            </Link>
            <Link
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
            {(isNl ? [
              ...
              <Link
                key={item.label}
                href={item.href}
                className="block p-5 bg-white rounded-xl border border-gray-200 hover:border-white hover:shadow-md transition-all"
              >
                <p className="text-white text-sm font-semibold uppercase tracking-widest mb-1">{item.label}</p>
      ...
      <section className="bg-[#1B2B5E] py-16 text-center">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href={`${base}/catering`}
              className="inline-flex items-center justify-center rounded-full border-2 border-white bg-white/10 px-8 py-3 text-white font-medium uppercase tracking-wide transition-all duration-200 hover:bg-[rgba(199,163,72,0.3)] min-h-[48px]"
            >
