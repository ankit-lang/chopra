...
export default function LocaleMenuPage({ params }: Props) {
  ...
  const statPills = isNl
    ? [`${menuItems.length} Gerechten`, `${menuCategories.length} Categorieën`, '100% Halal', 'Vegetarische Opties', 'Dagelijks Vers']
    : [`${menuItems.length} Dishes`, `${menuCategories.length} Categories`, '100% Halal', 'Vegetarian Options', 'Fresh Daily']

  const faqs = isNl ? menuFaqsNl : menuFaqsEn

  const menuMarqueeItems = isNl
    ? [
        '100% Halal',
        'Veganistische en Glutenvrije Opties Beschikbaar',
        'Dagelijks Vers',
        'Authentieke Indiase Smaak',
      ]
    : [
        '100% Halal',
  ...
  return (
    <>
      ...
      {/* Marquee Banner */}
      <MarqueeBanner items={menuMarqueeItems} />

      {/* DIETARY & SPICE GUIDE LEGEND */}
      <MenuLegend locale={locale} />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-10">
            ...
            <div>
              ...
              {isNl ? (
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  <Link href={`${base}/pani-puri-den-haag`} className="text-[#06068a] font-semibold">Pani puri</Link>,{' '}
                  <Link href={`${base}/chaat-den-haag`} className="text-[#06068a] font-semibold">papdi chaat, dahi puri en aloo tikki</Link>{' '}
                ...
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  <Link href={`${base}/pani-puri-den-haag`} className="text-[#06068a] font-semibold">Pani puri</Link>,{' '}
                  <Link href={`${base}/chaat-den-haag`} className="text-[#06068a] font-semibold">papdi chaat, dahi puri, and aloo tikki</Link>{' '}
            ...
            <div>
              ...
              {isNl ? (
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/indo-chinese-restaurant-den-haag`} className="text-[#06068a] font-semibold">Manchow soep</Link>{' '}
                ...
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/indo-chinese-restaurant-den-haag`} className="text-[#06068a] font-semibold">Manchow soup</Link>{' '}
            ...
            <div>
              ...
              {isNl ? (
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/tandoori-den-haag`} className="text-[#06068a] font-semibold">tandoori kip</Link>{' '}
                  een echte rokerige korst en krijgt{' '}
                  <Link href={`${base}/naan-den-haag`} className="text-[#06068a] font-semibold">naan</Link>{' '}
                ...
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/tandoori-den-haag`} className="text-[#06068a] font-semibold">tandoori chicken</Link>{' '}
            ...
            <div>
              ...
              {isNl ? (
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  <Link href={`${base}/butter-chicken-den-haag`} className="text-[#06068a] font-semibold">Butter chicken</Link>{' '}
            ...
            <div>
              ...
              {isNl ? (
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  <Link href={`${base}/mutton-rogan-josh-den-haag`} className="text-[#06068a] font-semibold">Mutton rogan josh</Link>{' '}
                ...
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/halal-food-den-haag`} className="text-[#06068a] font-semibold">halal certified</Link>{' '}
            ...
            <div>
              ...
              {isNl ? (
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/dal-makhani-den-haag`} className="text-[#06068a] font-semibold">Dal makhani</Link>,{' '}
            ...
            <div>
              ...
              {isNl ? (
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  De{' '}
                  <Link href={`${base}/biryani-den-haag`} className="text-[#06068a] font-semibold">biryani bij Chopras</Link>{' '}
                ...
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  The{' '}
                  <Link href={`${base}/biryani-den-haag`} className="text-[#06068a] font-semibold">biryani at Chopras</Link>{' '}
            ...
            <div>
              ...
              {isNl ? (
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/indo-chinese-restaurant-den-haag`} className="text-[#06068a] font-semibold">Indo-Chinees eten</Link>{' '}
                ...
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/indo-chinese-restaurant-den-haag`} className="text-[#06068a] font-semibold">Indo Chinese food</Link>{' '}
            ...
            <div>
              ...
              {isNl ? (
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/dal-makhani-den-haag`} className="text-[#06068a] font-semibold">Dal makhani</Link>,{' '}
                  paneer tikka,{' '}
                  <Link href={`${base}/soya-chaap-den-haag`} className="text-[#06068a] font-semibold">soya chaap</Link>,{' '}
                  ...
                  <Link href={`${base}/vegan-menu`} className="text-[#06068a] font-semibold">veganistische menuopties bij Chopras</Link>.
                </p>
              ) : (
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/vegan-menu`} className="text-[#06068a] font-semibold">vegan menu options at Chopras</Link>.
                </p>
              )}
            </div>
            ...
            <div>
              ...
              {isNl ? (
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  <Link href={`${base}/naan-den-haag`} className="text-[#06068a] font-semibold">Naan bij Chopras</Link>{' '}
                ...
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  <Link href={`${base}/naan-den-haag`} className="text-[#06068a] font-semibold">Naan at Chopras</Link>{' '}
            ...
            <div>
              ...
              {isNl ? (
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/menu`} className="text-[#06068a] font-semibold">Indiaas restaurant menu Den Haag</Link>{' '}
                ...
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/menu`} className="text-[#06068a] font-semibold">Indian restaurant menu Den Haag</Link>{' '}
            ...
            <div>
              ...
              {isNl ? (
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/`} className="text-[#06068a] font-semibold">Chopras Indian Restaurant Den Haag</Link>{' '}
            ...
            <div>
              ...
              {isNl ? (
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/halal-food-den-haag`} className="text-[#06068a] font-semibold">halal gecertificeerde eetervaring in Den Haag</Link>{' '}
                ...
                <p className="text-[#3A3A4A] text-base leading-relaxed">
                  ...
                  <Link href={`${base}/halal-food-den-haag`} className="text-[#06068a] font-semibold">halal-certified dining experience in Den Haag</Link>{' '}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <Link
              ...
              className="btn-gradient inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 text-white text-sm font-semibold uppercase tracking-wide min-h-[48px]"
            >
      ...
      <section className="bg-[#F7F8FC] py-20 px-6 md:px-16">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-heading text-3xl md:text-4xl text-[#06068a] mb-12 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link href={`${base}/biryani-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              <p className="text-[#06068a] text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Kenmerkend Gerecht' : 'Signature Dish'}</p>
              <p className="text-[#06068a] font-semibold text-lg">{isNl ? 'Lees meer over onze biryani in Den Haag' : 'Learn about our biryani in Den Haag'}</p>
            </Link>
            <Link href={`${base}/butter-chicken-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              <p className="text-[#06068a] text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Favoriet van Gasten' : 'Fan Favorite'}</p>
              <p className="text-[#06068a] font-semibold text-lg">{isNl ? 'Het verhaal achter onze butter chicken' : 'The story behind our butter chicken'}</p>
            </Link>
            <Link href={`${base}/tandoori-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              <p className="text-[#06068a] text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Tandoori Specialiteiten' : 'Tandoori Specials'}</p>
              <p className="text-[#06068a] font-semibold text-lg">{isNl ? 'Onze tandoori specialiteiten in Den Haag' : 'Our tandoori specialities Den Haag'}</p>
            </Link>
            <Link href={`${base}/dal-makhani-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              <p className="text-[#06068a] text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Vegetarische Lekkernij' : 'Vegetarian Delight'}</p>
              <p className="text-[#06068a] font-semibold text-lg">{isNl ? 'Dal makhani Den Haag' : 'Dal makhani Den Haag'}</p>
            </Link>
            <Link href={`${base}/chaat-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              <p className="text-[#06068a] text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Street Food' : 'Street Food'}</p>
              <p className="text-[#06068a] font-semibold text-lg">{isNl ? 'Indiase street food en chaat Den Haag' : 'Indian street food and chaat Den Haag'}</p>
            </Link>
            <Link href={`${base}/halal-food-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              <p className="text-[#06068a] text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Halal Gecertificeerd' : 'Halal Certified'}</p>
              <p className="text-[#06068a] font-semibold text-lg">{isNl ? 'Ons volledige halal Indiase menu Den Haag' : 'Our full halal Indian menu Den Haag'}</p>
            </Link>
            <Link href={`${base}/mutton-rogan-josh-den-haag`} className="block p-6 bg-white rounded-lg border border-gray-200 hover:border-[#06068a]/30 hover:shadow-lg transition-all">
              <p className="text-[#06068a] text-sm font-semibold uppercase tracking-widest mb-2">{isNl ? 'Lams Curry' : 'Lamb Curry'}</p>
              <p className="text-[#06068a] font-semibold text-lg">{isNl ? 'Mutton rogan josh Den Haag - onze Kashmiri lams-curry' : 'Mutton rogan josh Den Haag - our Kashmiri lamb curry'}</p>
            </Link>
          </div>
          <div className="mt-12 pt-12 border-t border-gray-200 space-y-4">
            <p className="text-[#1A1A1A] text-base leading-relaxed">
              {isNl ? (
                <>
                  Op zoek naar <Link href={`${base}/blog/vegetarian-indian-food-den-haag`} className="text-[#06068a] font-semibold">vegetarisch Indiaas eten Den Haag</Link>? Of geïnteresseerd in <Link href={`${base}/catering`} className="text-[#06068a] font-semibold">Indiase catering in Den Haag voor uw evenement</Link>?
                </>
              ) : (
                <>
                  Looking for <Link href={`${base}/blog/vegetarian-indian-food-den-haag`} className="text-[#06068a] font-semibold">vegetarian Indian food Den Haag</Link>? Or interested in <Link href={`${base}/catering`} className="text-[#06068a] font-semibold">Indian catering in Den Haag for your event</Link>?
                </>
              )}
            </p>
            <p className="text-[#1A1A1A] text-base leading-relaxed">
              {isNl ? (
                <>
                  Bezoek <Link href={`${base}/`} className="text-[#06068a] font-semibold">Chopras Indian Restaurant - beste Indiaas restaurant in Den Haag</Link> of <Link href={`${base}/contact`} className="text-[#06068a] font-semibold">reserveer een tafel bij Chopras Indian Restaurant</Link>.
                </>
              ) : (
                <>
                  Visit <Link href={`${base}/`} className="text-[#06068a] font-semibold">Chopras Indian Restaurant - best Indian restaurant in Den Haag</Link> or <Link href={`${base}/contact`} className="text-[#06068a] font-semibold">make a reservation at Chopras Indian Restaurant</Link>.
                </>
              )}
            </p>
          </div>
      ...
      >
        <div className="max-w-3xl mx-auto">
          <p className="text-xs uppercase tracking-widest text-white font-medium mb-6">
          ...
          <p className="text-white/80 text-base md:text-lg leading-relaxed mb-10">
            {isNl
              ? 'Geopend van dinsdag tot zondag · 16:30 tot 22:30 · Leyweg 986, Den Haag'
      ...
      <div className="bg-[#F7F8FC] py-12 px-6 md:px-16">
        <div className="max-w-3xl mx-auto">
          <div className="bg-[#0000B3]/10 border-l-4 border-white rounded-r-xl p-6 flex gap-4 items-start">
            <Info className=" text-[#1A1A1A] w-5 h-5 flex-shrink-0 mt-0.5" />
            <div>
              ...
              <p className=" text-[#1A1A1A] text-xs font-medium mt-3 uppercase tracking-widest">
