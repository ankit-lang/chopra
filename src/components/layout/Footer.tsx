...
export default function Footer({ locale }: { locale: Locale }) {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF] text-white overflow-hidden pt-24 border-t border-white/10">
      {/* Ambient Background Glows */}
      <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-white/5 rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-[800px] h-[800px] bg-[#000066]/50 rounded-full blur-[180px] pointer-events-none" />
      ...
      <div className="max-w-[90rem] mx-auto px-6 md:px-12 relative z-10 pb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          <div className="bg-white/[0.05] backdrop-blur-md border border-white/10 rounded-[2rem] p-8 md:p-10 hover:bg-white/[0.08] transition-colors duration-500 flex flex-col group">
            <Link href={base} className="block transform group-hover:scale-105 transition-transform duration-500 origin-left mb-8 -mt-4">
              <Image
                src={RESTAURANT.logo}
                alt="Chopras Indian Restaurant logo"
                width={180}
                height={70}
                className="h-20 md:h-24 w-auto object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]"
              />
            </Link>
          ...
          <div className="bg-white/[0.05] backdrop-blur-md border border-white/10 rounded-[2rem] p-8 md:p-10 hover:bg-white/[0.08] transition-colors duration-500 flex flex-col">
            ...
            <div className="flex flex-col gap-5 font-body font-light text-[15px] text-white/90">
              <div className="flex justify-between items-center bg-white/10 rounded-xl p-4 border border-white/10">
                ...
                <span className="text-[#000066] font-bold bg-white px-3 py-1 rounded-full text-sm">16:30 - 22:30</span>
              </div>
          ...
          <div className="bg-white/[0.05] backdrop-blur-md border border-white/10 rounded-[2rem] p-8 md:p-10 hover:bg-white/[0.08] transition-colors duration-500 flex flex-col">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-10">
              <a href={RESTAURANT.social.instagram} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 rounded-full border border-white/20 bg-white/10 hover:bg-white hover:text-[#000066] hover:scale-110 transition-all duration-300 shadow-lg">
              ...
              <a href={RESTAURANT.social.youtube} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 rounded-full border border-white/20 bg-white/10 hover:bg-white hover:text-[#000066] hover:scale-110 transition-all duration-300 shadow-lg">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" /></svg>
              </a>
              <a href={RESTAURANT.social.tiktok} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 rounded-full border border-white/20 bg-white/10 hover:bg-white hover:text-[#000066] hover:scale-110 transition-all duration-300 shadow-lg">
              ...
              <a href={RESTAURANT.social.x} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 rounded-full border border-white/20 bg-white/10 hover:bg-white hover:text-[#000066] hover:scale-110 transition-all duration-300 shadow-lg">
            ...
            <div className="flex flex-col gap-4 mt-auto">
              ...
              >
                <div className="flex text-white group-hover:text-[#000066] text-2xl tracking-widest leading-none transition-colors duration-300">★★★★★</div>
                <div className="flex flex-col relative z-10">
                  <span className="text-sm font-bold tracking-wide text-white group-hover:text-[#000066] transition-colors duration-300">Google Reviews</span>
                  <span className="text-[10px] text-white/80 group-hover:text-[#000066]/80 uppercase tracking-widest transition-colors duration-300 mt-1">Based on 1,000+ Reviews</span>
                </div>
              </a>
              ...
              >
                <div className="flex text-white group-hover:text-[#000066] text-2xl tracking-widest leading-none transition-colors duration-300">★★★★★</div>
                <div className="flex flex-col relative z-10">
                  <span className="text-sm font-bold tracking-wide text-white group-hover:text-[#000066] transition-colors duration-300">TripAdvisor</span>
                  <span className="text-[10px] text-white/80 group-hover:text-[#000066]/80 uppercase tracking-widest transition-colors duration-300 mt-1">Rated Excellent</span>
                </div>
              </a>
            </div>
          </div>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-white/10 bg-gradient-to-b from-[#000066] via-[#0000B3] to-[#0000FF]  backdrop-blur-xl relative z-20">
