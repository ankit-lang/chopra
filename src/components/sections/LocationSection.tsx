...
export default function LocationSection({ locale = 'en' }: { locale?: Locale }) {
  ...
  return (
    <section
      className="pt-10 pb-10 md:pt-5 md:pb-5 relative overflow-hidden btn-gradient "
    // style={{ background: 'linear-gradient(135deg, #06068a 0%, #0000B3 100%)' }}
    >
      {/* Background Ambience */}
      <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-white/20 to-transparent" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1100px] h-[1100px] rounded-full bg-white/5 blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-[90rem] mx-auto px-5 md:px-12 relative z-10" ref={ref}>
        ...
        >
          <span className="inline-flex items-center justify-center gap-1.5 rounded-full bg-white/95 px-6 py-2 text-lg md:text-xl font-heading text-[#06068a] shadow-lg mb-4">
            Find <span className="font-normal">Us</span>
          </span>
        ...
        >
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2456.2!2d4.2765!3d52.0583!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47890e3caeb27bfd%3A0x8c0b2b2a5c3e4f9a!2sLeyweg%20986%2C%202545%20GW%20Den%20Haag!5e0!3m2!1sen!2snl!4v16110000000000!5m2!1sen!2snl"
            width="100%"
            height="100%"
          ...
          <div className="absolute bottom-6 right-6 z-20">
            <a
              ...
              className="group flex items-center gap-3 rounded-full bg-white px-6 py-3 text-transparent bg-clip-text btn-gradient text-sm font-bold uppercase tracking-widest shadow-[0_8px_30px_rgba(0,0,0,0.3)] transition-all duration-300 hover:scale-105 hover:shadow-[0_8px_40px_rgba(255,255,255,0.2)]"
            >
